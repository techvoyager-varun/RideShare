...
function UserHomeScreen() {
  ...
  const getDistanceAndFare = async (pickupLocation, destinationLocation) => {
    ...
    try {
      ...
      setMapLocation({
        center: [response.data.distanceTime.originCoords.ltd, response.data.distanceTime.originCoords.lng],
        pickup: [response.data.distanceTime.originCoords.ltd, response.data.distanceTime.originCoords.lng],
        destination: [response.data.distanceTime.destCoords.ltd, response.data.distanceTime.destCoords.lng],
        captain: null
      });
  ...
  useEffect(() => {
    ...
    socket.on("ride-confirmed", (data) => {
      ...
      setMapLocation({
        ...
        pickup: data.pickupCoords ? [data.pickupCoords.ltd, data.pickupCoords.lng] : null,
        destination: null,
